...
public class UrlUtilTest {
     ...
     */
    @Test
    public void testQueryStringToMap_NormalCase() {
        String queryString = "timeOption=0&page=1&pageSize=10&keyPlace=1&sort=dateDesc&qt=*";
        
        Map<String, String> result = UrlUtil.queryStringToMap(queryString);
     ...
     */
    @Test
    public void testQueryStringToMap_EmptyInput() {
        assertNull(UrlUtil.queryStringToMap(null));
        assertNull(UrlUtil.queryStringToMap(""));
        assertNull(UrlUtil.queryStringToMap("   "));
    }
     ...
     */
    @Test
    public void testQueryStringToMap_UrlEncoded() {
     ...
     */
    @Test
    public void testQueryStringToMap_EmptyKeyValue() {
     ...
     */
    @Test
    public void testQueryStringToMap_SinglePair() {
     ...
     */
    @Test
    public void testQueryStringToMap_SpecialCharacters() {
