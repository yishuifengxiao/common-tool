...
public class ECCTest {
    ...
    public void test_all() throws Exception {
        ...
        String publicKeyHex =
                "042B44482A1263864699D706A5290E45075EACF8437C89D4FB2AB60F9D5524CF49ECF860609BA8E920011FD2A8DE2B23D7085A7832B7EE6FC0E73F0B66E0212227";
        ...
        boolean isTamperedValid = ECC.verifySignature(publicKey, tamperedData.getBytes(StandardCharsets.UTF_8),
                signature);
        ...
        try {
            ...
            for (String oid : curveOIDs) {
                try {
                    ...
                    boolean isValid = ECC.verifySignature(keyPair.getPublic(), data.getBytes(StandardCharsets.UTF_8),
                            signature);
    ...
    public void testSignAndVerifyFlow() {
        try {
            ...
            boolean invalidResult = ECC.verifySignature(publicKey, wrongData.getBytes(StandardCharsets.UTF_8),
                    signature);
