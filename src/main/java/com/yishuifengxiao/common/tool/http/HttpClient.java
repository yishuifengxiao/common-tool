...
public class HttpClient {
	 ...
	 * @return 请求的响应体的响应文本
	 */
	public static String postForm(String url, Map<String, String> headers, Map<String, String> data) {
	 ...
	 * @return 请求的响应体的响应文本
	 */
	public static String postJson(String url, Map<String, String> headers, Map<String, String> data) {
	 ...
	 * @return 响应
	 */
	public static String executeAsString(String url, String method, String contentType, Map<String, String> headers,
	...
	private Connection connection() {
		Assert.isNotBlank(this.url, "请求的url不能为空");
