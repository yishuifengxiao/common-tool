...
public class HttpClient {
	 ...
	 * @return 响应
	 */
	public Connection.Response execute(String url, String method, String contentType, Map<String, Object> headers,
	 ...
	 * @return 响应
	 */
	public String executeAsString(String url, String method, String contentType, Map<String, Object> headers,
			Map<String, Object> data) {
		this.url = url;
		this.method = method;
		this.contentType = contentType;
	...
	private Connection connection() {
		Assert.notBlank(this.url, "请求的url不能为空");
