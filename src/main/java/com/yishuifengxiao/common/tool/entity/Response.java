...
public class Response<T> implements Serializable {
     ...
     */
    @Schema(name ="请求ID,用于请求追踪 .无论调用接口成功与否,都会返回请求 ID,该序列号全局唯一且随机")
     ...
     */
    @Schema(name ="请求的响应码,这里借用HttpStatus作为状态标识,具体代码的含义请参见 HttpStatus( https://developer.mozilla" +
     ...
     */
    @Schema(name =" 响应提示信息,一般与响应码的状态对应,对响应结果进行简单地描述")
    protected String msg;

    /**
     * 响应数据，在基本基本信息无法满足时会出现此信息,一般情况下无此信息
     */
    @Schema(name =" 响应数据，在基本基本信息无法满足时会出现此信息,一般情况下无此信息")
    @JsonProperty("data")
    protected T data;
